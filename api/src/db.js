...
const { Spendings, Expenses, Apartment, Buildings, Alerts, User, Complaints, Admin, Amenity, Booking, Subscription, Services, Ratings, Payment } = sequelize.models; //ir agregando los modelos que se crean.
