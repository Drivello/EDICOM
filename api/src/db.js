...
const { Spendings, Expenses, Apartment, Buildings, Alerts, User, Complaints, Admin, Amenity, Booking, Subscription, Services, Rating } = sequelize.models; //ir agregando los modelos que se crean.
