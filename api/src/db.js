...
let capsEntries = entries.map((entry) => [entry[0][0].toUpperCase() + entry[0].slice(1), entry[1]]); //mayuscula 1 letra
sequelize.models = Object.fromEntries(capsEntries); //[Key, value]

// En sequelize.models están todos los modelos importados como propiedades
// Para relacionarlos hacemos un destructuring

const { Amenities, Services , Buildings} = sequelize.models; //ir agregando los modelos que se crean.
